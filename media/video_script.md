...
> **Production Structure:** 3 Core Modules / 7 Video Segments edited into a seamless, high-impact presentation.

---

## 📊 Master Video Time Budget & Segment Breakdown

| Module | Seg | Section | Presenter / Source | Duration | Recording Type |
|---|---|---|---|---|---|
| **Module 1** | 1 | **Executive Project Pitch & Market Problem** | Voiceover + Motion Graphics | 2:00 | B-roll, Slides, Charts |
| | 2 | **Cisco Tech Alignment & Architecture** | Voiceover + Diagrams | 1:30 | Technical Diagrams & Web Scroll |
| **Module 2** | 3 | **Victor's Customer Testimonial (Cap Vermell)** | Víctor (IT Director) | 1:30 | On-Site Video (Mallorca Resort) |
| **Module 3** | 4 | **José's Executive Intro & KIW Track Record** | José Plá (KIW Founder) | 1:30 | Camera / Talking Head |
| | 5 | **Live Working Code & API Integrations** | Screen Recording + Code | 1:30 | IDE, Terminal, Splunk, Meraki API |
| | 6 | **Live End-to-End Demo (Chat & Voice AI)** | Screen Recording + ToIP Phone | 1:30 | Webex/Telegram + Room Ext 1999 Voice |
| | 7 | **Executive Closing & Call to Action** | José Plá (KIW Founder) | 0:30 | Camera / Talking Head |
| | | **TOTAL TIME** | | **10:00** | |

---

## 🎬 MODULE 1: GENERAL PROJECT PITCH & STRATEGIC NARRATIVE (3:30)

### Segment 1 — Executive Project Pitch & The Problem (2:00)
**Visual Style:** Dynamic B-roll of NOC screens, alert cascades, factory SCADA lines, hospital wards, and animated data cards.  
**Audio:** Voiceover (English) — Energetic, executive-grade.

**Script (Voiceover):**
> *"Every day, enterprise IT operations and Managed Service Partners are drowning in alert fatigue. Critical infrastructure environments generate thousands of daily telemetry events across fragmented networking, security, and building management tools.*
>
...
### Segment 2 — Cisco Tech Alignment & 2-Phase Architecture (1:30)
**Visual Style:** Screen recording scrolling through `https://pic26.kiw.one/draft.html`, animating the architecture diagrams and Cisco product stack.  
**Audio:** Voiceover (English).

**Script (Voiceover):**
> *"TellMAX.AI binds Cisco’s core portfolio into a single, conversational execution brain.
> 
...
>
> To drive seamless onboarding and zero friction, TellMAX.AI follows a 2-Phase Architecture:
> - Phase 1 (Cloud-Hybrid Speed): Currently deployed in active production, providing instant L0/L1 incident resolution without requiring upfront hardware installation.
> - Phase 2 (Sovereign On-Premise Enterprise Option): For enterprise datacenters with strict privacy or DORA mandates, MAX migrates 100% on-premise onto Cisco UCS AI Pod servers with dual NVIDIA GPUs, guaranteeing total local data privacy.
>
> By closing the human expertise gap, MAX ensures customers actively use the Cisco features they own — driving higher retention, strengthening subscription renewals, and aligning directly with the Cisco 360 Partner Program."*
...
## 🎬 MODULE 3: JOSÉ'S EXECUTIVE INTRO, TRACK RECORD & LIVE DEMO (5:00)

### Segment 4 — José's Executive Intro & KIW Track Record (1:30)
...
>
> Concurrently, MAX interfaces with Splunk Enterprise via the REST API using Search Processing Language (SPL). When Splunk flags a network anomaly or VLAN traffic spike, MAX cross-references the live sensor data and queries Catalyst Center APIs to perform TDR cable tests and verify switch port health.
>
...
### Segment 6 — Live End-to-End Working Demo (Chat & Voice AI) (1:30)
...
1. **Natural Language Incident Triage (0:00 - 0:45):**
...
2. **Interactive Hands-Free Voice AI Call (0:45 - 1:30):**
...
### Segment 7 — Executive Closing & Call to Action (0:30)
...
## 🛠️ Production & Recording Guidelines

1. **Víctor's Segment (Segment 3):**
   - Record horizontally using iPhone (1080p/4K).
   - Good lighting, Cap Vermell resort background.
   - Victor speaks clearly following his 2-part script.

2. **José's Segments (Segments 4 & 7):**
   - Record in clean HD/4K with good lighting and dedicated microphone (or AirPods Pro).
   - Professional tech background.

3. **Screen Recordings (Segments 2, 5 & 6):**
   - Record at 1920x1080 resolution using OBS Studio or QuickTime.
   - High-contrast terminal fonts (monospaced) and clean browser tabs (`https://pic26.kiw.one/draft.html?preview=pic26dev`).

4. **Editing & Final Assembly:**
   - Combine all 7 segments into a single MP4 file (<10 minutes).
   - Add clean text overlays for key metrics: **"MTTR Reduction: -85%"**, **"$39k/min SCADA Downtime Prevented"**, **"Splunk HEC + Meraki API + Cisco CUBE Voice"**.
   - Background music: subtle, inspiring, non-intrusive tech soundtrack.
